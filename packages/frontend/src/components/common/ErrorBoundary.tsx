  ...
  return (
    <div className="min-h-[400px] flex items-center justify-center p-6">
      <div className="bg-paper rounded-small border border-black/[0.08] shadow-paper p-8 max-w-md text-center">
        {/* Error icon with subtle animation on display */}
        <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-oppose/10 flex items-center justify-center animate-in zoom-in duration-300">
          <WarningIcon size="lg" className="text-oppose" decorative />
        </div>
